...
from services.execute_task_qux_worker.execute_task_qux_worker import handler
...
class TestExecuteTaskQuxWorker:
    """
    ************************************************************
    ...
    ************************************************************
    ...
    def test_continues_if_sqs_record_is_invalid_json(self):
        ...
        with patch("services.execute_task_qux_worker.execute_task_qux_worker.event_store_client"):
    ...
    ************************************************************
    ...
    def test_calls_from_eventbridge_sqs_record_with_step_processed_event(self):
        ...
        with patch("services.execute_task_qux_worker.execute_task_qux_worker.event_store_client") as mock_client:
    ...
    ************************************************************
    ...
    def test_creates_task_qux_executed_event_with_correct_data(self):
        sqs_record = build_mock_sqs_record_with_step_processed_event()
        sqs_event = {"Records": [sqs_record]}
        ...
        with patch("services.execute_task_qux_worker.execute_task_qux_worker.event_store_client") as mock_client:
            ...
            assert isinstance(call_args, TaskQuxExecutedEvent)
            assert call_args.eventName == "TASK_QUX_EXECUTED_EVENT"
    ...
    ************************************************************
    ...
    def test_continues_if_error_event_already_raised_exception(self):
        ...
        mock_event = TaskQuxExecutedEvent.from_data(
    ...
    ************************************************************
    ...
    def test_creates_task_qux_executed_event_with_correct_job_status(self):
        sqs_record = build_mock_sqs_record_with_step_processed_event()
        sqs_event = {"Records": [sqs_record]}
        ...
        with patch("services.execute_task_qux_worker.execute_task_qux_worker.event_store_client") as mock_client:
            ...
            call_args = mock_client.raise_event.call_args[0][0]
            task_event_data: TaskQuxExecutedEventData = call_args.eventData
